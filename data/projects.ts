export const projects = [
    ...
    {
        id: 'studysync-admin',
        title: '스터디 일정 관리 캘린더 어드민',
        description: '스터디 일정 관리 캘린더 서비스 운영을 위한 관리자 대시보드',
        stack: [
            'Next.js',
            'TypeScript',
            'TanStack Query',
